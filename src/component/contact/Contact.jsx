...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_mc0rdld', 'template_us1ndhl', form.current, {
            publicKey: 'wxuqxGA4JcaDEsbzC',
          })
          e.target.reset()
    };
  return (
            ...
            <div className="contact_content">
                ...
                <div className="contact_info">
                    <div className="contact_card">
                        ...
                        <span className="contact_card-data">apideth.tupairor03@gmail.com</span>
                        
                        <a href="mailto:apideth.tupairor03@gmail.com" className="contact_button">Write me{" "}
                    ...
                    <div className="contact_card">
                        ...
                        <span className="contact_card-data">Apideth Tupairor</span>

                        <a href="https://m.me/popapideth" className="contact_button">Write me{" "} 
                        <i className="bx bx-right-arrow-alt contact_button-icon"></i>
                        </a>
                    </div>
                </div>
